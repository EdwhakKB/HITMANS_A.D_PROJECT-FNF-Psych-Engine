...
class CharacterEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	function makeUIMenu()
	{
		...
		UI_characterbox = new PsychUIBox(UI_box.x - 100, UI_box.y + UI_box.height + 10, 350, 280, ['Character', 'Animations']);
	...
	var disableQuantCheckBox:PsychUICheckBox;
	...
	function addCharacterUI()
	{
		...
		disableQuantCheckBox =  new PsychUICheckBox(noAntialiasingCheckBox.x, noAntialiasingCheckBox.y + 40, "Disable Quant", 120);
		disableQuantCheckBox.checked = character.disableQuant;
		disableQuantCheckBox.onClick = function() {
