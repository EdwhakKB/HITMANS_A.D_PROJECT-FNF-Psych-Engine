...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	function addEditorBox() {
		...
		var loadWeekButton:PsychUIButton = new PsychUIButton(0, 650, "Load Week", function() {
			loadWeek();
		});
		...
		var freeplayButton:PsychUIButton = new PsychUIButton(0, 650, "Freeplay", function() {
		...
		var saveWeekButton:PsychUIButton = new PsychUIButton(0, 650, "Save Week", function() {
			saveWeek(weekFile);
		});
	...
	function reloadBG() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			OpenFLAssets.exists(Paths.getPath('images/menubackgrounds/menu_' + assetName + '.png', IMAGE), IMAGE)) {
	...
	function reloadWeekThing() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			OpenFLAssets.exists(Paths.getPath('images/storymenu/' + assetName + '.png', IMAGE), IMAGE)) {
