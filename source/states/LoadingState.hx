...
class AsyncAssetPreloader
{
	...
	private function generatePreloadList()
	{
		if (PlayState.SONG != null){
			...
			audio.push(Paths.getPath(Paths.formatToSongPath(PlayState.SONG.song) + '/Inst.ogg'));
			if (PlayState.SONG.needsVoices)
				audio.push(Paths.getPath(Paths.formatToSongPath(PlayState.SONG.song) + '/Voices.ogg'));
...
class LoadingState extends MusicBeatState
{
	...
	{
		return Paths.getPath(Paths.formatToSongPath(PlayState.SONG.song) + '/Inst.ogg');
	}
	
	static function getVocalPath()
	{
		return Paths.getPath(Paths.formatToSongPath(PlayState.SONG.song) + '/Voices.ogg');
	}
