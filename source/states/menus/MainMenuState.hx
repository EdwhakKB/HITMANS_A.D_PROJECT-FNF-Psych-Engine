...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		folder.antialiasing = ClientPrefs.data.antialiasing;
		add(folder);
		...
		pcTime.alpha = 1;
		pcTime.antialiasing = ClientPrefs.data.antialiasing;
		pcTime.updateHitbox();
		...
		pcInside.antialiasing = ClientPrefs.data.antialiasing;
		...
		pcThing.antialiasing = ClientPrefs.data.antialiasing;
