...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		personajes.antialiasing = ClientPrefs.data.antialiasing;
		...
		cuadroTexto.antialiasing = ClientPrefs.data.antialiasing;
	...
	function changeItem(huh:Int = 0)
		{
			...
			grupo.forEach(function(spr:FlxSprite)
				{
					FlxTween.tween(spr.offset, {x: 815 * curSelected}, 0.2, {ease: FlxEase.expoOut, type: FlxTweenType.ONESHOT});
