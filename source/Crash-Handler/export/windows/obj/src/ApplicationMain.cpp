...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Hitmans-CrashDialog",2e,8f,98,df),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("12",e1,2a,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("HitmansCorps",dd,0b,88,ae));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Hitmans-CrashDialog",2e,8f,98,df));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Hitmans Corporation: Crash Handler",d7,99,b6,dc));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("1.0",b3,56,25,00));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),440)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),640)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Hitmans Corporation: Crash Handler",d7,99,b6,dc))
