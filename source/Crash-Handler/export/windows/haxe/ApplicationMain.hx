...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Hitmans-CrashDialog", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Hitmans-CrashDialog", null, 440, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "12";
		app.meta["company"] = "HitmansCorps";
		app.meta["file"] = "Hitmans-CrashDialog";
		app.meta["name"] = "Hitmans Corporation: Crash Handler";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Hitmans Corporation: Crash Handler",
			width: 440,
			x: null,
			y: null,
		};
