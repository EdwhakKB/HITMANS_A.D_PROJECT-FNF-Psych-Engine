...
class FlxCamera extends FlxBasic
{
	...
	@:noCompletion
	public function startTrianglesBatch(graphic:FlxGraphic, smoothing:Bool = false, isColored:Bool = false, ?blend:BlendMode, ?hasColorOffsets:Bool, ?shader:FlxShader, ?cullMode:TriangleCulling):FlxDrawTrianglesItem
	{
		var blendInt:Int = FlxDrawBaseItem.blendToInt(blend);
	...
	@:noCompletion
	public function getNewDrawTrianglesItem(graphic:FlxGraphic, smoothing:Bool = false, isColored:Bool = false, ?blend:BlendMode, ?hasColorOffsets:Bool, ?shader:FlxShader, ?cullMode:TriangleCulling):FlxDrawTrianglesItem
	{
	...
	public function drawTriangles(graphic:FlxGraphic, vertices:DrawData<Float>, indices:DrawData<Int>, uvtData:DrawData<Float>, ?colors:DrawData<Int>,
			?position:FlxPoint, ?blend:BlendMode, repeat:Bool = false, smoothing:Bool = false, ?transform:ColorTransform, ?shader:FlxShader, ?cullMode:TriangleCulling):Void
	{
		if (FlxG.renderBlit)
		{
			if (position == null)
