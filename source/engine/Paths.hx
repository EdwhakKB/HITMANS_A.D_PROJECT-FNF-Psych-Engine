...
class Paths
{
	...
	inline static public function getFilePath(key:String, ?parentFolder:String = null):String
	{
		if (fileExists(key, TEXT, false, parentFolder))
			return Paths.getPath(key, TEXT, parentFolder);
		return null;
	}
