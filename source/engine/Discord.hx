...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1021986935792730273";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.state = ClientPrefs.data.discordRPC ? state : "NO LEAKS HERE";
		presence.details = ClientPrefs.data.discordRPC ? details : "CENSORED ";
		presence.smallImageKey = smallImageKey;
		presence.largeImageKey = largeImageKey;
		presence.largeImageText = "Hitmans Version: " + states.menus.MainMenuState.psychEngineVersion;
