...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		FlxG.save.bind('Hitmans AD', 'ShadowMario');
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Hitmans Engine by'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Edwhak_KB', 15);
					addMoreText('...', 15);
					addMoreText('yes just him', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 14:
					addMoreText('Annihilate &');
				// credTextShit.visible = true;
				case 15:
					addMoreText('Destroy');
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('HITMANS!'); // credTextShit.text += '\nFunkin';
