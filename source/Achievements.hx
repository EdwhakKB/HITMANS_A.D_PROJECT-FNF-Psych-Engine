...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["FNF Night Gamer",				"Play on a Friday... Night.",						'friday_night_play',	 true],
		...
		["And you call yourself a hitman?",	"Complete a Song with a rating lower than 20%.",	'ur_bad',			false],
		["Call me The Hitman",			"Complete a Song with a rating of 100%.",			'ur_good',				false],
